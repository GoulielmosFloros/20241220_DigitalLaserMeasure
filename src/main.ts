...
import { AppManager, LaserMeasurer } from "./bim-components";
...
// Write the following right before the toolbar declaration in the template
const laserMeasurer = components.get(LaserMeasurer);
laserMeasurer.world = world;
laserMeasurer.enabled = true;
viewport.addEventListener("mousemove", () => laserMeasurer.measure());
